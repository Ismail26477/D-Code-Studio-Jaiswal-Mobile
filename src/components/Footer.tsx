        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">Jaiswal Mobile</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:info@jaiswalmobile.com" className="text-white/70 hover:text-primary text-sm">
                    info@jaiswalmobile.com
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-white/60 text-sm text-center md:text-left">
              © {new Date().getFullYear()} Jaiswal Mobile. All rights reserved.
            </p>
